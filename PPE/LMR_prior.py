...
def prior_assignment(iprior):
    ...
    elif iprior == 'MRI_CGCM3_last_millenium':
        prior_object = prior_MRI_CGCM3_last_millenium()
    elif iprior == 'GISS-E2-R_last_millenium':
        prior_object = prior_GISS_E2_R_last_millenium()
    elif iprior == 'HadCM3_last_millenium':
        prior_object = prior_HadCM3_last_millenium()
    ...
    elif iprior == 'CMCC-CM_preindustrial_control':
        prior_object = prior_CMCC_CM_preindustrial_control()
    elif iprior == 'MIROC-ESM':
        prior_object = prior_MIROC_ESM()   
    elif iprior == 'MIROC-ESM-MCA':
        prior_object = prior_MIROC_ESM_MCA() 
    elif iprior == 'MIROC-ESM-LIA':
        prior_object = prior_MIROC_ESM_LIA()     
    elif iprior == 'MIROC-ESM-PD':
        prior_object = prior_MIROC_ESM_PD()  
    elif iprior == 'CCSM4-MCA':
        prior_object = prior_CCSM4_MCA() 
    elif iprior == 'CCSM4-LIA':
        prior_object = prior_CCSM4_LIA()     
    elif iprior == 'CCSM4-PD':
        prior_object = prior_CCSM4_PD()  
    elif iprior == 'CCSM4-non_MCA':
        prior_object = prior_CCSM4_non_MCA() 
    elif iprior == 'CCSM4-non_LIA':
        prior_object = prior_CCSM4_non_LIA()     
    elif iprior == 'CCSM4-non_PD':
        prior_object = prior_CCSM4_non_PD()  
    return prior_object
...
# class for the CCSM4 Last Millennium simulation
class prior_HadCM3_last_millenium(prior_master):
...
# class for the CCSM4 Last Millennium simulation
class prior_MRI_CGCM3_last_millenium(prior_master):
...
# class for the CCSM4 Last Millennium simulation
class prior_GISS_E2_R_last_millenium(prior_master):
...
# class for the CCSM4 Last Millennium simulation
class prior_CMCC_CM_preindustrial_control(prior_master):
...
# class for the CCSM4 Last Millennium simulation
class prior_MIROC_ESM(prior_master):
...
# class for the CCSM4 Last Millennium simulation
class prior_MIROC_ESM_MCA(prior_master):
...
# class for the CCSM4 Last Millennium simulation
class prior_MIROC_ESM_LIA(prior_master):
...
# class for the CCSM4 Last Millennium simulation
class prior_MIROC_ESM_PD(prior_master):
...
# class for the CCSM4 Last Millennium simulation
class prior_CCSM4_MCA(prior_master):
...
# class for the CCSM4 Last Millennium simulation
class prior_CCSM4_LIA(prior_master):
...
# class for the CCSM4 Last Millennium simulation
class prior_CCSM4_PD(prior_master):
...
# class for the CCSM4 Last Millennium simulation
class prior_CCSM4_non_MCA(prior_master):
...
# class for the CCSM4 Last Millennium simulation
class prior_CCSM4_non_LIA(prior_master):
...
# class for the CCSM4 Last Millennium simulation
class prior_CCSM4_non_PD(prior_master):
